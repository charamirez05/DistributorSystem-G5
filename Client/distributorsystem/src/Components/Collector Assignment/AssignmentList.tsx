...
const StyledNumTypography = styled(Typography)({
  textAlign: 'left',
  fontWeight: 'bold',
...
// document.title = 'Assignment Collector'; // Set the document title
    ...
    return( 
        <div>        
            ...
            {/* Card For Number of Order Transaction Records */}
            <Card sx={{ margin:"40px 0px 0px 0px", borderRadius:"15px",  display:"flex"}}>
                <div className='numDiv'>
                    <StyledNumTypography gutterBottom variant="h6">
            ...
            {/* Combo Box-Filter Collector Name */}
                        <Autocomplete
                            ...
                            renderInput={(params) => <TextField {...params} label="All" sx={{ width: 250,  '& .MuiInputLabel-root': {
                                color: '#146C94', 
  ...
  {/* Combo box- Assign Collector */}
                    <CardActions sx={{  alignItems: 'center', marginLeft: '10px' }}>
                        <Autocomplete
                              ...
                              renderInput={(params) => <TextField {...params}  InputProps={{ ...params.InputProps, disableUnderline: true, style: { fontSize: "15px", backgroundColor: "#E9E9E9",
